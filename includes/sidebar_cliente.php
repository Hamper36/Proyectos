...
<div class="col-md-2 sidebar min-vh-100 p-3">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
            <a class="nav-link text-white <?php echo ($actual_file == 'solicitar_traslado.php') ? 'active' : ''; ?>" href="solicitar_traslado.php">
                <i class="bi bi-taxi-front-fill"></i> Solicitar traslado
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link text-white <?php echo ($actual_file == 'mis_traslados.php') ? 'active' : ''; ?>" href="mis_traslados.php">
                <i class="bi bi-map"></i> Mis traslados
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link text-white <?php echo ($actual_file == 'recargar_saldo.php') ? 'active' : ''; ?>" href="recargar_saldo.php">
                <i class="bi bi-cash-coin"></i> Recargar saldo
            </a>
        </li>
        <li class="nav-item mb-2">
            <a class="nav-link text-white <?php echo ($actual_file == 'historial_recargas.php') ? 'active' : ''; ?>" href="historial_recargas.php">
                <i class="bi bi-clock-history"></i> Historial de recargas
            </a>
        </li>
        <li class="nav-item mb-2">
