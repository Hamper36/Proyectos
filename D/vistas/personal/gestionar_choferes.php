...
$sql = "SELECT COUNT(*) AS total FROM usuario WHERE id_rol = 4 AND estado_usuario IN ('Pendiente', 'Pendiente por Renovación')";
...
(solo su vehículo inicial, para evitar duplicados
 cuando el chofer tiene varios vehículos registrados)
=========================*/
...
$sql = "SELECT c.id_chofer, u.id_usuario, u.nombres, u.apellidos, u.cedula, u.correo, u.telefono,
               ...
               (SELECT COUNT(*) FROM revision_vehiculo rv WHERE rv.id_vehiculo = v.id_vehiculo) AS tiene_revisiones
        FROM chofer c
        INNER JOIN usuario u ON u.id_usuario = c.id_usuario
        LEFT JOIN vehiculo v ON v.id_vehiculo = (
            SELECT MIN(id_vehiculo) FROM vehiculo WHERE id_chofer = c.id_chofer
        )
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($ch = $choferes->fetch_assoc()) { ?>
                                        ...
                                        <?php
                                        $texto_estado = $ch["estado_usuario"];
                                        if ($ch["estado_usuario"] == "Pendiente" && isset($ch["tiene_revisiones"]) && $ch["tiene_revisiones"] > 0) {
                                            $texto_estado = "Pendiente por Renovación";
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge <?php echo $badge; ?>"><?php echo $texto_estado; ?></span></td>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="../../procesos/evaluar_chofer.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?php
                                    $es_renovacion = (isset($ch["tiene_revisiones"]) && $ch["tiene_revisiones"] > 0);
                                    ?>

                                    <?php if (in_array($ch["estado_usuario"], ["Pendiente", "Pendiente por Renovación"])) { ?>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="calificacion_evaluacion" class="form-control" min="0" max="100" oninput="if(this.value !== '') { if(parseInt(this.value) < 0) this.value = 0; if(parseInt(this.value) > 100) this.value = 100; }" required>
                                                </div>
                                                <div class="col-12">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Calificación (0 - 100)</label>
                                                    <input type="number" name="calificacion_revision" class="form-control" min="0" max="100" oninput="if(this.value !== '') { if(parseInt(this.value) < 0) this.value = 0; if(parseInt(this.value) > 100) this.value = 100; }" required>
                                                </div>
                                                <div class="col-12">
                                                    <label class="form-label">Observación</label>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="numero_cuenta" class="form-control" maxlength="20" pattern="[0-9]{1,20}" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '').slice(0, 20)" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
