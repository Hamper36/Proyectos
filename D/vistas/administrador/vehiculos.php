...
if ($estado_filtro !== 'Todos' && !empty($estado_filtro)) {
    $where_clauses[] = "v.estado_vehiculo = ?";
...
/*=========================
NOTA: se usa v.estado_vehiculo como fuente confiable del
estado (no revision_vehiculo.resultado), ya que puede haber
vehículos cuyo estado se fijó manualmente sin una revisión
registrada. El LEFT JOIN se conserva solo para mostrar los
datos de la última revisión en el detalle.
=========================*/

$sql = "SELECT v.*, u.nombres, u.apellidos, u.telefono, u.correo,
               rv.fecha_revision, rv.calificacion, rv.observacion
        FROM vehiculo v
                                            ...
                                            <?php foreach ($vehiculos_list as $v) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($v['estado_vehiculo'] == 'Apto') $badge_est = 'bg-success';
                                                        if ($v['estado_vehiculo'] == 'No Apto') $badge_est = 'bg-danger';
                                                        if ($v['estado_vehiculo'] == 'Inactivo') $badge_est = 'bg-secondary';
                                                        ?>
                                                        <span class="badge <?php echo $badge_est; ?>"><?php echo htmlspecialchars($v['estado_vehiculo']); ?></span>
                                                    </td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-start">
                    ...
                    <hr>
                    <p><strong>Estado Actual:</strong> <?php echo htmlspecialchars($v['estado_vehiculo']); ?></p>
                    <?php if (!empty($v['observacion'])) { ?>
                        <p><strong>Última Observación:</strong> <?php echo htmlspecialchars($v['observacion']); ?></p>
                    <?php } ?>
                </div>
                                ...
                                <tbody>
                                    <?php while ($h = $historial->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $h['calificacion']; ?> / 100</td>
                                            <td>
