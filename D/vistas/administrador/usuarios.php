...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 dashboard p-4">
            ...
            <!-- BOTÓN NUEVO PERSONAL ADMINISTRATIVO -->
            <div class="row justify-content-center mb-3">
                <div class="col-lg-11 d-flex justify-content-end">
                    <button type="button" class="btn btn-success fw-bold" data-bs-toggle="modal" data-bs-target="#modalNuevoPersonal">
                        <i class="bi bi-person-plus-fill me-1"></i> Registrar Personal Administrativo
                    </button>
                </div>
            </div>
                                            ...
                                            <?php foreach ($usuarios_list as $u) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (in_array($u['estado_usuario'], ['Pendiente', 'Pendiente por Renovación'])) $badge_est = 'bg-warning text-dark';
                                                        if ($u['estado_usuario'] == 'Inactivo') $badge_est = 'bg-secondary';
                                                        if ($u['estado_usuario'] == 'Rechazado') $badge_est = 'bg-danger';
                                                        ?>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php if ($u['estado_usuario'] == 'Activo') { ?>
                                                            <form action="../../procesos/toggle_estado_usuario.php" method="POST" style="display:inline;">
                                                        ...
                                                        <?php } elseif ($u['estado_usuario'] == 'Inactivo') { ?>
                                                            <form action="../../procesos/toggle_estado_usuario.php" method="POST" style="display:inline;">
                                                                <input type="hidden" name="id_usuario" value="<?php echo $u['id_usuario']; ?>">
...
<div class="modal fade" id="modalNuevoPersonal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="../../procesos/registrar_personal_admin.php">
                <div class="modal-header text-white" style="background:#1E2E4F;">
                    <h5 class="modal-title"><i class="bi bi-person-plus-fill me-2"></i>Registrar Personal Administrativo</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body row g-3 text-start">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cedula" class="form-control" maxlength="8" minlength="7" pattern="[0-9]{7,8}" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '').slice(0, 8)" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telefono" class="form-control" maxlength="11" pattern="[0-9]{11}" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '').slice(0, 11)">
                    </div>
                    <div class="col-md-6">
